import { LimitPriceNoticeInfo } from './response/limitPriceNoticeInfo';
...
export interface MyInfoApi {
   ...
   */
  postLimitPriceNotice(userName: string, limitPriceNoticeInfoList: LimitPriceNoticeInfo[]): Promise<void>;
  /**
   * 식재료 상한가 하한가 목록 조회
   * @param userName 유저 ID
   */
